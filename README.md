...
加强对于构建工具的使用，测试用例的编写，`gulp`、`grunt`、`webpack`、`esbuild`、`SWC`、`vite`、`trubo` 等构建工具的掌握和选择，提升技术水平。以 `React` 为前端框架，`React Hooks` 作为核心产出，从 0 ～ 1 搭建一个前端业务 `Hooks` 库，从产品设计、框架选择、架构设计到最终的编码落地，通过一个完整的产品实现，解决如何提升代码复用的问题。
...
3. 结合`unpkg`进行在线 dist 文件访问：[https://www.unpkg.com/cy-hooks](https://www.unpkg.com/cy-hooks)；
...
- **GitHub**: <https://github.com/1Chen1y1111>
